...
const LEAD_CREATE="leads/create";
...
const NAV_MENU=["Project Highlights","About","Amenities","FloorPlan","Price Plan","Gallery","Location"]
export {STATIC_PHONE, API_URL,LOCATION_IMG,FORM_ICON,
    MY_LOCATION,PROJECT_LOGO,GET_DATA_API,HOMESFY_LOGO,HOMESFY_URL, LEAD_CREATE,
    HOMESFY_FACEBOOK,HOMESFY_INSTAGRAM,FA_ICON,NAV_MENU}
